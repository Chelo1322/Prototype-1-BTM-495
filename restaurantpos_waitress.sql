...
CREATE TABLE `waitress` (
  ...
  `waitressID` int NOT NULL,
  `name` varchar(50) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  `phone_number` varchar(15) DEFAULT NULL,
  `role` varchar(50) DEFAULT 'Waitress',
  `shift` varchar(50) DEFAULT NULL,
  `salary` float DEFAULT NULL,
  `Empl_ID` int DEFAULT NULL,
  PRIMARY KEY (`waitressID`)
...
LOCK TABLES `waitress` WRITE;
/*!40000 ALTER TABLE `waitress` DISABLE KEYS */;
/*!40000 ALTER TABLE `waitress` ENABLE KEYS */;
UNLOCK TABLES;
